...
### 1. Tambahkan Badges di GitHub
Edit bagian badges sesuai kebutuhan:
```markdown
[![Stars](https://img.shields.io/github/stars/yourusername/server-monitor?style=social)](https://github.com/yourusername/server-monitor)
[![Issues](https://img.shields.io/github/issues/yourusername/server-monitor)](https://github.com/yourusername/server-monitor/issues)
[![Pull Requests](https://img.shields.io/github/issues-pr/yourusername/server-monitor)](https://github.com/yourusername/server-monitor/pulls)
```

### 2. Tambahkan GIF Demo
Jika ingin lebih menarik, tambahkan GIF recording:
```markdown
## 🎬 Demo
...
### 3. Tambahkan Contributing Guide
```markdown
## 🤝 Contributing
...
- Real-time UI dengan blessed
- Alert system dengan notifications
- 4 view modes (Dashboard, Processes, Network, Alerts)
```
